...
@Component({
  selector: 'vex-memorando-ocho',
  templateUrl: './memorando-31.component.html',
  styleUrls: ['./memorando-31.component.scss']
})
export class Memorando31Component implements OnInit {
  ...
  setFileName() {
    ...
    const name = `memo_recomendar_31_${this.groupId}_${this.currentDate.getFullYear()}-${this.currentDate.getMonth() + 1}-${this.currentDate.getDate()}.pdf`;
