...
@Component({
  selector: 'vex-grupos-aprobados',
  templateUrl: './grupos-aprobados.component.html',
  styleUrls: ['../solicitud-grupos-fase-diez/solicitud-grupos-fase-diez.component.scss']
})
export class GruposAprobadosComponent implements OnInit {
  ...
  obtenerAnexos(id: number) {
    this.annexesService.getByGroupType(id, `acta_comite_inv_${id}`).subscribe((data) => {
