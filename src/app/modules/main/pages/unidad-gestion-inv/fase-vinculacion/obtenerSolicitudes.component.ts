...
export class SolicitudesComponent39 implements OnInit {
    ...
    getGrupo() {
        if (this.departmentUser) {
            this.invGroupService.getByProcess('35').subscribe({//CAMBIAR A 38
                next: (data) => {
    ...
    validar(id: number) {
        ...
        this.router.navigate(['main/mostrar-solicitud-vinculacion']);
    }
}
