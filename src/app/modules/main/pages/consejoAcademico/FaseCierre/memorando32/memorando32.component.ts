...
@Component({
  selector: 'vex-memorando32',
  templateUrl: './memorando32.component.html',
  styleUrls: ['./memorando32.component.scss']
})
export class Memorando32Component implements OnInit {
  ...
  setFileName() {
    ...
    const name = `resolucion_recomendar_32_${this.groupId}_${this.currentDate.getFullYear()}-${this.currentDate.getMonth() + 1}-${this.currentDate.getDate()}.pdf`;
