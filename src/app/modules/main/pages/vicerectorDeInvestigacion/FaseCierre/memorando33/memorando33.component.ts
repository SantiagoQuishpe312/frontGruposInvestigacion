...
@Component({
  selector: 'vex-memorando33',
  templateUrl: './memorando33.component.html',
  styleUrls: ['./memorando33.component.scss']
})
export class Memorando33Component implements OnInit {
 selectedFile: File | undefined;
  ...
  setFileName() {
    ...
    const name = `memo_recomendar_33_${this.groupId}_${this.currentDate.getFullYear()}-${this.currentDate.getMonth() + 1}-${this.currentDate.getDate()}.pdf`;
