...
@Component({
  selector: 'vex-memorando34',
  templateUrl: './memorando34.component.html',
  styleUrls: ['./memorando34.component.scss']
})
export class Memorando34Component implements OnInit {
selectedFile: File | undefined;
  ...
  setFileName() {
    ...
    const name = `memo_recomendar_34_${this.groupId}_${this.currentDate.getFullYear()}-${this.currentDate.getMonth() + 1}-${this.currentDate.getDate()}.pdf`;
